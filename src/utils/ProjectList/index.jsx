    ...
    const [project] =useState([
      {
        ...
        Github: 'https://github.com/JunyaQ/GoGamesGo',
        Deploy:'https://desolate-hollows-73074.herokuapp.com/'
      },
      {
        ...
        Github: "https://github.com/JunyaQ/activity-music",
        Deploy:"https://ScalexanderB.github.io/activity-music/"
      },
      {
        ...
        Github: "https://github.com/JunyaQ/Ashop",
        Deploy:"https://asimpleshop.herokuapp.com/"
      },
      {
        project_name:"Quiz",
        ...
        Github:"https://github.com/JunyaQ/Quiz",
        Deploy:"https://junyaq.github.io/Quiz/"
      },
      {
        ...
        Github:'https://github.com/JunyaQ/coffee',
        Deploy:'https://starwarcoffee.herokuapp.com/'
      },
      {
        ...
        Github: 'https://github.com/JunyaQ/BankTracker',
        Deploy:"https://budget-tracker-offline-use.herokuapp.com/"
      },
      {
        ...
        Role: 'Sole author',
        Tools: 'HTML, CSS, Javascript, API',
        Github: 'https://github.com/JunyaQ/bootcamp-challenge-weatherAPI',
        Deploy: "https://junyaq.github.io/bootcamp-challenge-weatherAPI/"
      },
      {
        project_name:'Memory Card Game',
        description: 
        'This is a game that user can adust the number of cards they want and start the game. User need to flip two cards to see if they matched, if so the card will not flip back, otherwise, the card will flip back. When all the card flipped to the front, the game is over',
        Role: "Sole author",
...
<div class="column">
  ...
  <h4 className="project_name">{project.project_name}</h4>
    ...
    <p ><a href={project.Github} className='link'>view on Github</a></p>
    <p><a href={project.Deploy} className='link'>view deployed page</a></p>
  </div>
</div>
